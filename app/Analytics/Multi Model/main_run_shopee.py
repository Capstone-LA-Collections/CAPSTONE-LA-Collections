...
def main():
    ...
    for model_name in MODELS_TO_RUN:
        ...
        try:
            ...
            csv_name = f"{OUTPUT_DIR}/Shopee_{model_name}_3yr_forecast.csv"
            ...
            plt.legend()
            plt.savefig(f"{OUTPUT_DIR}/Shopee_{model_name}_plot.png")
            plt.close()
    ...
    print(metrics_df)
    metrics_df.to_csv(f"{OUTPUT_DIR}/Shopee_model_performance_metrics.csv", index=False)
